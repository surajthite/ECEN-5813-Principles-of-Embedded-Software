 ...
 * 				this pattern algorithm  is referenced on https://stackoverflow.com/questions/7602919/how-do-i-generate-random-numbers-without-rand-function thread to create a random sequence on the basis of seed value.
 * 				More randomization have been attained by implementing complex logic using seed value in the calculations. The random value set generated is different for each seed value.
