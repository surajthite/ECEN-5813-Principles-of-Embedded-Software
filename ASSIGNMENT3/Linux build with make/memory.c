...
/*******************************************************************************************************
 * Function Name:uint32_t* allocate_words(uint32_tlength)
 * Description : this function allocates memory of type uint32_tof specified length(nos).
 * @input:Length
...
/*******************************************************************************************************
 * Function Name:size_t* display_mem(uint32_t* loc, uint32_tlength)
 ...
 * @Return :uint32_ttype of pointer
 *******************************************************************************************************/
...
/*******************************************************************************************************
 * Function Name:mem_status invert_block(uint32_t* loc, uint32_tlength)
...
/*******************************************************************************************************
 * Function Name:mem_status write_pattern(uint32_t* loc, uint32_tlength, uint8_t seed)
...
/*******************************************************************************************************
 * Function Name:uint32_t* verify_pattern(uint32_t* loc, uint32_tlength, int8_t seed)
 * Description : This function verifies the generated pattern at location pointed by the pointer
 * @input:pointer to the memory location and length and seed value
 * @Return :pointer of uint32_ttype which returns the address of different value
 *******************************************************************************************************/
 ...
 * @Return :pointer of uint32_ttype which returns the absolute  address of the memory location
 *******************************************************************************************************/
