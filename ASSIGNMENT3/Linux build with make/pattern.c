...
/*******************************************************************************************************
 * Function Name:void mem_status_write_pattern_array(uint32_t * loc, uint32_t length, uint8_t seed)
...
/*******************************************************************************************************
 * Function Name:void gen_pattern(uint32_t * pattern, uint32_t length, int8_t seed)
