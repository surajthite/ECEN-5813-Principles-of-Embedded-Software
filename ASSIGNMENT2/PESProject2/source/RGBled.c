...
/*******************************************************************************/
/* Function name:status_print_on(int n)
 * Parameters: current index  n
 * Return : void
 * Description: Function to print the current state on the UART . */
/*******************************************************************************/
...
void status_print_on(int n)
 {
	switch (n)
	{
	// Print the state for  Switch LED BLUE ON and TURN OTHER LEDs OFF
	case 0:
		{
			PRINTF(" BLUE LED ON ::");
		}
		break;
		// Print the state for Switch LED RED ON and TURN OTHER LEDs OFF
	case 1:
	{
		...
		PRINTF(" GREEN LED ON ::");
			...
			break;
			// Print the state for Switch LED GREEN ON and TURN OTHER LEDs OFF
	case 2:
	{
		PRINTF(" RED LED ON :: ");
	}
...
/*******************************************************************************/
/* Function name:status_print_off()
 * Parameters: void
 * Return : void
 * Description: Fucntion to print the off status on the Terminal screen .
/*******************************************************************************/
